...
if ($emailresult == "") {
    ...
    if($passwordresult == ""){
        ...
        $_SESSION['country']="";
        $_SESSION['bio']="";
        header("Location:travelUser.php");
    }
}
}
...
<header class="backGround ">
    ...
    <!--      navbar   -->
    <nav class="navbar navbar-expand-sm navbar-fixed-top myNavbar">
        ...
        <div class="container-fluid collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="AttractionGuest.php">Attraction</a>
                </li>
        ...
        <div class="modal-dialog modal-dialog-centered " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="shape">
                        <form method="POST" action="travelGuest.php">
                            <!--                            email input-->
